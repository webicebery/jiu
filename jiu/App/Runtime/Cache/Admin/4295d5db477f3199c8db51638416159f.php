	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="text-c">
				...
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo ($val["real_name"]); ?>','Userinfo.html?user_id=<?php echo ($val["user_id"]); ?>','<?php echo ($val["user_id"]); ?>','360','400')"><?php echo ($val['user_name']); ?></u></td>
				<td><?php echo ($val['real_name']); ?></td>
				<td><?php echo ($val['user_sex']); ?></td>
				<td><img src="/jiu/Public/homeIcon/<?php echo ($val["user_icon"]); ?>" alt="" height="50px"></td>
				<td><?php echo ($val['user_tel']); ?></td>
				
				<td><?php echo ($val['user_email']); ?></td>
				<td><?php echo ($val['user_level']); ?></td>
				<td><?php echo ($val['addtime']); ?></td>
				<td class="td-status"><span class="label label-success radius"><?php echo ($val['user_status']); ?></span></td>
				<td class="td-manage"><a title="编辑" href="javascript:;" onclick="member_edit('编辑','user_edit.html?id=<?php echo ($val["user_id"]); ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></td>
...
<script type="text/javascript" src="/jiu/Public/lib/laypage/1.2/laypage.js"></script> 
