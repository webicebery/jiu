      ...
      <div class="lecar_wap">
                              <div class="lepay_wrap" id="lepay_wrap" style="margin:0 auto;">
                                  <div class="lepay_content">
                                      <div class="none_shop">
                                          <p style="font-size:20px;">订单已完成!，请到<a href="/jiu_xiangmu/xiangmu/jiu/Home/User/index" style="text-decoration:none; color:blue;">个人中心</a>中查看订单详情</p>
                                          <a href="/jiu_xiangmu/xiangmu/jiu/Home/index/show" style="color:red; text-align:center; ">继续购物>></a>
                                      </div>
                                  </div>
                              </div>
                         </div>     
