...
<script type="text/javascript" src="/jiu_xiangmu/xiangmu/jiu/Public/static/h-ui/js/H-ui.js"></script>
    ...
    <div class="container">
         <form class="form-horizontal" role="form" action="/jiu_xiangmu/xiangmu/jiu/Home/ShopCart/pay" method="post" name="form">
            ...
            <div class="form-group">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="radio" name='status' value='<?php echo ($value[lid]); ?>' <?php echo ($value['l_status']==1 ? 'checked' : ''); ?>  ></td>
                            <td><?php echo ($value['l_name']); ?></td>
                            <td><?php echo ($value['l_address']); ?></td>
                            <td><?php echo ($value['l_tel']); ?></td>
            ...
            <div class="cart-info2">
                <table class="cart-table2 table table-hover">
                   ...
                   <?php if(is_array($data)): foreach($data as $key=>$val): ?><tr>
                            ...
                            <td><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val['picture']); ?>" style="width:50px;"></td>
                            <td><?php echo ($val["price"]); ?></td>
                            <td>
                            <input type="text" style="width:25px; border:none;"  value="<?php echo ($val["num"]); ?>" readonly>
                            </td>
                            <td>￥<?php echo ($val['num']*$val['price']); ?>元</td>
                            </tr>
                            <?php $total += $val['num']*$val['price'] ; endforeach; endif; ?>     
                    </tbody>
                    
                </table>
            <div class="form-group">
                <div  style="font-size:20px;font-weight:bold;color:#a10000;float:right;">总计：￥<?php echo ($total); ?>元</div>
                <input type="hidden" name="totally" value="<?php echo ($total); ?>">
            </div>
        </div>
